...
const styles = StyleSheet.create({
  ...
  tallyNum: { fontSize: typography.size.xxl, fontFamily: typography.fonts.display, color: palette.correct },
  tallyLabel: { fontSize: typography.size.md, color: palette.inkSoft, fontFamily: typography.fonts.body },
  ...
  addText: { color: palette.onPrimary, fontFamily: typography.fonts.display, fontSize: typography.size.md },
  list: { maxHeight: 150 },
  ...
  chipText: { fontSize: typography.size.sm, fontFamily: typography.fonts.body, color: palette.inkSoft },
});
