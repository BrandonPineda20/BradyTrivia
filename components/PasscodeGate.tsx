...
const styles = StyleSheet.create({
  ...
  sub: { color: palette.inkSoft, fontSize: typography.size.md, fontWeight: typography.weight.medium, textAlign: "center", marginTop: spacing(1), marginBottom: spacing(2) },
  input: {
    width: "100%",
  ...
  errorText: { color: palette.incorrect, fontSize: typography.size.sm, fontWeight: typography.weight.heavy },
  btn: { marginTop: spacing(2), alignSelf: "stretch" },
  fine: { color: palette.neutral, fontSize: typography.size.xs, fontWeight: typography.weight.medium, textAlign: "center", marginTop: spacing(3) },
});
